...
# Drop the existing users table if you need to recreate it with the image column
...
def recognize_face(face_embedding, current_face):
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        name, stored_image = recognize_face(face_embedding, face_pil)
        if name == "Unknown":
            ...
            # Display the stored image from the database (optional)
            stored_image.show()
